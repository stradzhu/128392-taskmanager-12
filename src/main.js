  ...
  return (
    `<section class="main__filter filter container">
      ...
      <label for="filter__all" class="filter__label">
        All <span class="filter__all-count">2</span>
      </label>
...
render(sort, createSortItemTemplate(), `beforeend`);
render(sort, createSortItemTemplate(), `beforeend`);
render(sort, createSortItemTemplate(), `beforeend`);

render(tasks, createEditTaskTemplate(), `beforeend`);

render(tasks, createTaskTemplate(), `beforeend`);
render(tasks, createTaskTemplate(), `beforeend`);
render(tasks, createTaskTemplate(), `beforeend`);
